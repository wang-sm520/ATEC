...
class LocomotionVelocityRoughEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        # G1 humanoid on Task A terrain (29 dof + stairs/slopes) generates ~170MB of contacts
        # at 4096 envs; default 64MB drops contacts (feet phase through stairs). Bump to 512MB.
